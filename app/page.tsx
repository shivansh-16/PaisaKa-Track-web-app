...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--pk-bg)' }}>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t px-4 py-2" style={{ borderColor: 'var(--pk-border)' }}>
        <div className="flex items-center justify-around">
          <a href="/" className="flex flex-col items-center gap-1 py-2 px-4" style={{ color: 'var(--pk-orange)' }}>
            <div className="text-xl">🏠</div>
            <div className="text-xs font-medium">Home</div>
          </a>
          <a href="/dashboard/analytics" className="flex flex-col items-center gap-1 py-2 px-4" style={{ color: 'var(--pk-text-secondary)' }}>
            <div className="text-xl">📊</div>
            <div className="text-xs font-medium">Analytics</div>
          </a>
          <a href="/groups" className="flex flex-col items-center gap-1 py-2 px-4" style={{ color: 'var(--pk-text-secondary)' }}>
            <div className="text-xl">👥</div>
            <div className="text-xs font-medium">Groups</div>
          </a>
          <a href="/profile" className="flex flex-col items-center gap-1 py-2 px-4" style={{ color: 'var(--pk-text-secondary)' }}>
            <div className="text-xl">👤</div>
